...
public:
  ...
  void DeleteItem_4A(ItemType item);

  void DeleteItem_4B(ItemType item);
...
// Q4 - A
template <class ItemType>
void UnsortedType<ItemType>::DeleteItem_4A(ItemType item) {
...
// Q4 - B
template <class ItemType>
void UnsortedType<ItemType>::DeleteItem_4B(ItemType item) {
    NodeType<ItemType>* predLoc;  // trailing pointer (후행)
    NodeType<ItemType>* location; // traveling pointer
    bool moreToSearch;
