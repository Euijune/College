...
struct HeapType
{
  ...
  //Q1
  void ReheapDown_nonrecur(int root, int bottom);
  void ReheapUp_nonrecur(int root, int bottom);
...
// Q1-A
template<class ItemType>
void HeapType<ItemType>::ReheapDown_nonrecur(int root, int bottom)
...
// Q1-B
template<class ItemType>
void HeapType<ItemType>::ReheapUp_nonrecur(int root, int bottom)
